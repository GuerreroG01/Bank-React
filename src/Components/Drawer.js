...
import PeopleIcon from '@mui/icons-material/People'; // Asegúrate de que esta línea esté presente
import HomeIcon from '@mui/icons-material/Home';
import AccountBalanceIcon from '@mui/icons-material/AccountBalance';
import CreditCardIcon from '@mui/icons-material/CreditCard';
import { useNavigate } from 'react-router-dom';

import BankLogo from '../assets/Images/Bank_Icon2.png';
        ...
        <List>
          ...
          <ListItem key="Tarjetas" disablePadding sx={{ display: 'block' }}>
            ...
            >
              ...
              <ListItemText primary="Tarjetas" sx={{ opacity: open ? 1 : 0 }} />
            </ListItemButton>
          </ListItem>
        </List>
      </Drawer>
